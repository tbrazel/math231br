...
\end{theorem}
As a consequence of this theorem we can say that a spectral sequence $E^{\bullet, \bullet}_\bullet$ \textit{converges to} $H^\bullet(E^\bullet)$ or that a page $E_r^{\bullet,\bullet}$ \texit{abuts} to $H^\bullet(E^\bullet)$.
