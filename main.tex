...
The following proposition is subtle!
...
\end{align*}
is a short exact sequence of presheaves, it induces a long exact sequence
\begin{align*}
...
\end{align*}
\end{proposition}
\begin{proof}[Sketch] The first thing to reconcile is what we mean by ``short exact sequence of presheaves.'' This means \emph{sectionwise} short exact, i.e. over an open set $U$ we get a short exact sequence. This implies stalkwise exactness but not vice versa -- in particular we can have sequences of sheaves that are exact as sheaves but not as presheaves.

The first step is to show that, for any cover $\mathcal{U}$, the functor
\begin{align*}
    \check{C}^q(\mathcal{U},-) \colon \Fun(\Open(X)^\op,\Ab)
\end{align*}
...
This begs a very interesting question --- when do the \v{C}ech cohomology of a presheaf $F$ and of its sheafification $F^\sharp$ agree?
