...
\begin{example} We have that $\Omega^0_\dR$ is the sheaf of real-valued differentiable functions on $M$, and $\Omega^1_\dR$ is the sheaf of sections of the cotangent bundle.
\end{example}
