...
% Shouldn't the morphism be from \Z_{U_1} \to \Z_{U_2}? i.e. shouldn't the functor be covariant since in Lemma 2.38 the given "canonical map" goes from smaller to larger? Thank you for the clarification.
