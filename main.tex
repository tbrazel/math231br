...
If $X$ is paracompact, Hausdorff, and locally contractible, and $A$ is any abelian group, there is an isomorphism between sheaf/\v{C}ech cohomology with constant coefficients and singular cohomology
\begin{align*}
