...
Let $\mathcal{A}$ be an abelian category, and let $\Fun^\ex(\mathcal{A},\Ab) \subseteq \Fun(\mathcal{A},\Ab)$ denote the full subcategory consisting of exact functors. Then $\Fun^\ex(\mathcal{A},\Ab)$ is closed under filtered colimits.
\end{corollary}
