...
Thank you to Zo\"{e} Batterman, Vincent Costa, Frank Gubars, Gabe Ong, and Greg Wong for offering suggestions and changes to the notes. Thanks to Gage Martin and Sidhanth Raman for helpful conversations in preparing this class.
...
\begin{remark} This procedure of producing a monomorphism into an injective object is not functorial. However it can be made functorial leveraging a functorial map into injective abelian groups --- this is spelled out in \cite[01DG]{Stacks}.
\end{remark}
